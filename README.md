...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dtool_tag-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dtool_tag-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `dtool_tag` available on your platform:
...
```
pixi search dtool_tag --channel conda-forge
```
