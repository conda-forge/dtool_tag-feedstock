...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtool_tag-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13114&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtool_tag-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtool_tag` can be installed with:

```
conda install dtool_tag
```

It is possible to list all of the versions of `dtool_tag` available on your platform with:
